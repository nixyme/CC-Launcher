...
const translations = {
  en: {
    ...
    'file.add': '+ Add File',
    'file.name': 'Name',
    'file.quickAction': 'Quick access to files',
    'url.url': 'URL',
  ...
  ja: {
    ...
    'file.add': '+ ファイルを追加',
    'file.name': '名前',
    'file.quickAction': 'ファイルへのクイックアクセス',
    'url.url': 'URL',
    'url.open': 'ブラウザで開く',
  ...
  fr: {
    ...
    'file.title': 'Fichiers',
    'file.add': '+ Ajouter fichier',
    'file.name': 'Nom',
    'file.quickAction': 'Accès rapide aux fichiers',
    'url.url': 'URL',
