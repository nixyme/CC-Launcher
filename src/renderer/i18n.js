...
const translations = {
  en: {
    ...
    'welcome.title': 'START EVERYTHING',
    ...
    'msg.imported': 'Added {added}, updated {updated}, deleted {deleted}',
    ...
    'settings.autoLaunchFailed': 'Failed to update auto-launch setting',
    'settings.autoLaunchDevMode': 'Auto-launch only works in production builds. Please build and install the app first.',
    ...
    'settings.authorName': 'nixy',
    'settings.wechat': 'WeChat',
    'settings.welcomeMsg': 'Welcome to chat & PRs are welcome!',
    ...
    'url.add': '+ Add URL',
    'url.name': 'Name',
    'url.quickAction': 'Quick access to URLs',
    'folder.title': 'Folders',
    'folder.add': '+ Add Folder',
    'folder.name': 'Name',
    'folder.quickAction': 'Quick access to folders',
    'file.title': 'Files / Apps',
    'file.add': '+ Add File / App',
    'file.name': 'Name',
    'file.quickAction': 'Quick access to files & apps',
    'url.url': 'URL',
    ...
    'subproject.title': 'Subprojects',
    'subproject.add': '+ Add Subproject',
    'subproject.name': 'Subproject name',
    'subproject.addItem': '+ Add Item',
    'subproject.itemType': 'Type',
    'subproject.typeUrl': 'URL',
    'subproject.typeFolder': 'Folder',
    'subproject.typeFile': 'File / App',
    'subproject.empty': 'No items',
  },
  zh: {
    'sidebar.title': '项目',
    ...
    'msg.imported': '新增 {added} 个，更新 {updated} 个，删除 {deleted} 个',
    ...
    'settings.autoLaunchFailed': '更新开机自启动设置失败',
    'settings.autoLaunchDevMode': '开机自启动仅在正式版本中有效。请先构建并安装应用。',
    ...
    'settings.about': '关于',
    'settings.author': '作者',
    'settings.authorName': '尼克西',
    'settings.wechat': '微信',
    'settings.welcomeMsg': '欢迎交流，欢迎 PR！',
    ...
    'url.add': '+ 添加网址',
    'url.name': '简称',
    'url.quickAction': '快速访问网址',
    'folder.title': '文件夹',
    'folder.add': '+ 添加文件夹',
    'folder.name': '简称',
    'folder.quickAction': '快速访问文件夹',
    'file.title': '文件/应用',
    'file.add': '+ 添加文件/应用',
    'file.name': '简称',
    'file.quickAction': '快速访问文件和应用',
    'url.url': '网址',
    'url.open': '在浏览器中打开',
    ...
    'logs.manual': '手动',
    'logs.scheduled': '定时',
    'subproject.title': '子项目',
    'subproject.add': '+ 添加子项目',
    'subproject.name': '子项目名称',
    'subproject.addItem': '+ 添加条目',
    'subproject.itemType': '类型',
    'subproject.typeUrl': '网址',
    'subproject.typeFolder': '文件夹',
    'subproject.typeFile': '文件/应用',
    'subproject.empty': '暂无条目',
  },
  ja: {
    ...
    'msg.imported': '{added}件追加、{updated}件更新、{deleted}件削除',
    ...
    'settings.autoLaunchFailed': '自動起動設定の更新に失敗しました',
    'settings.autoLaunchDevMode': '自動起動は本番ビルドでのみ機能します。アプリをビルドしてインストールしてください。',
    ...
    'url.add': '+ URLを追加',
    'url.name': '名前',
    'url.quickAction': 'URLへのクイックアクセス',
    'folder.title': 'フォルダ',
    'folder.add': '+ フォルダを追加',
    'folder.name': '名前',
    'folder.quickAction': 'フォルダへのクイックアクセス',
    'file.title': 'ファイル/アプリ',
    'file.add': '+ ファイル/アプリを追加',
    'file.name': '名前',
    'file.quickAction': 'ファイルとアプリへのクイックアクセス',
    'url.url': 'URL',
    'url.open': 'ブラウザで開く',
    ...
    'subproject.title': 'サブプロジェクト',
    'subproject.add': '+ サブプロジェクトを追加',
    'subproject.name': 'サブプロジェクト名',
    'subproject.addItem': '+ アイテムを追加',
    'subproject.itemType': 'タイプ',
    'subproject.typeUrl': 'URL',
    'subproject.typeFolder': 'フォルダ',
    'subproject.typeFile': 'ファイル/アプリ',
    'subproject.empty': 'アイテムなし',
  },
  fr: {
    ...
    'msg.imported': '{added} ajouté(s), {updated} mis à jour, {deleted} supprimé(s)',
    ...
    'settings.autoLaunchFailed': 'Échec de la mise à jour du lancement automatique',
    'settings.autoLaunchDevMode': 'Le lancement automatique ne fonctionne que dans les versions de production. Veuillez d\'abord créer et installer l\'application.',
    ...
    'settings.authorName': 'nixy',
    'settings.wechat': 'WeChat',
    'settings.welcomeMsg': 'Bienvenue pour discuter et les PRs sont les bienvenues !',
    ...
    'url.add': '+ Ajouter URL',
    'url.name': 'Nom',
    'url.quickAction': 'Accès rapide aux URL',
    'folder.title': 'Dossiers',
    'folder.add': '+ Ajouter dossier',
    'folder.name': 'Nom',
    'folder.quickAction': 'Accès rapide aux dossiers',
    'file.title': 'Fichiers / Apps',
    'file.add': '+ Ajouter fichier / app',
    'file.name': 'Nom',
    'file.quickAction': 'Accès rapide aux fichiers et apps',
    'url.url': 'URL',
    ...
    'subproject.title': 'Sous-projets',
    'subproject.add': '+ Ajouter sous-projet',
    'subproject.name': 'Nom du sous-projet',
    'subproject.addItem': '+ Ajouter élément',
    'subproject.itemType': 'Type',
    'subproject.typeUrl': 'URL',
    'subproject.typeFolder': 'Dossier',
    'subproject.typeFile': 'Fichier / App',
    'subproject.empty': 'Aucun élément',
  },
};
