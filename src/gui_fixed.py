...
class ProjectLauncherGUI:
    ...
    def _create_widgets(self):
        ...
        # 执行指令框架
        cmd_frame = tk.LabelFrame(right_frame, text="执行指令",
                                 font=('', 12, 'bold'),
                                 bg='white', fg='#333',
                                 padx=15, pady=10)
        cmd_frame.grid(row=2, column=0, sticky='nsew', padx=15, pady=(0, 15))

        tk.Label(cmd_frame, text="默认指令:", bg='white',
                font=('', 11, 'bold')).pack(anchor=tk.W)

        self.command_text = scrolledtext.ScrolledText(cmd_frame,
                                                      height=12,
                                                      wrap=tk.WORD,
                                                      font=('Courier', 11))
        ...
        tk.Button(exec_frame, text="🚀 启动项目",
        ...
        tk.Button(exec_frame, text="重置指令",
...
需要帮助? 查看 快速开始.md"""
    ...
    def _show_add_project_dialog(self):
        ...
        # 默认指令
        tk.Label(main, text="默认指令:", bg='white', font=('', 11, 'bold')).grid(
